public class Main {
    ...
    private static void exercise1() {
        ...
        System.out.println("text in upper case = "+someText.toUpperCase());
        System.out.println("text in lower case = "+someText.toLowerCase());
    }
    ...
    private static void exercise2() {
        System.out.println("\nExercise 2:");
        // Change these
        String firstName = "Alessandro";
        String middleName = "Amedeo";
        String lastName = "Venuti";
